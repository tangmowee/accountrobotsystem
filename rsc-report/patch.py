...
<div class="tldr">
  ...
  <ul>
    ...
    <li><b>เครดิตเฉลี่ยถ่วงน้ำหนักของงานปกติ = {WA26X:.1f} วัน ดีกว่าปี 2025 ({WA25X:.1f} วัน)</b> — คือผลงานการเจรจาเทอมจริง<br>
        <span style="color:var(--text-dim);">ตัวเลขรวมทั้งหมดแสดงเป็น {WA26:.1f} วัน เพราะโครงการ มิ.ย. ฿{credit['15d'][5]/1e6:.2f}M ถูกบันทึกเป็นเครดิต 15 วันในระบบ
        แต่เงื่อนไขจริงเป็นการ<b>แบ่งจ่ายหลายงวดแบบ Back-to-Back</b> ตัวเลข {WA26:.1f} วันจึงต่ำกว่าความเป็นจริง — ดูข้อ 8</span></li>
...
<div class="dnote">
  ...
  <ul>
    ...
    <li><b>ยอด PO ≠ เงินที่จ่ายจริง</b> — งานโครงการที่แบ่งจ่ายหลายงวดจะบันทึกยอด PO เต็มจำนวนในเดือนที่ออก PO
        แต่จ่ายจริงทยอยตามงวด (เช่นโครงการเดือน มิ.ย. ฿30.45M ปัจจุบันจ่ายเพียงเงินมัดจำ — ดูข้อ 8)</li>
...
rep('<div class="note">งาน Standard Parts เดือน มิ.ย. (PO ใหญ่ภายใต้ Credit 15d) ทำให้ 15d เป็นสัดส่วนสูงสุด 54.0% ของยอด Jan–Jul | เครดิต 15–60 วันรวม 94.4% | เงินสด (0d) 5.4%</div>',
    f'''<div class="note">
      <b style="color:var(--orange);">อ่านให้ถูก — ตัวเลขที่ใช้วัดผลคือ {WA26X:.1f} วัน ไม่ใช่ {WA26:.1f} วัน:</b><br>
      ตัดโครงการเดือน มิ.ย. ออก เครดิตเฉลี่ยถ่วงน้ำหนักอยู่ที่ <b>{WA26X:.1f} วัน</b> เทียบปี 2025 ที่ {WA25X:.1f} วัน —
      <span class="pos">ดีขึ้น {WA26X-WA25X:.1f} วัน คือผลงานการเจรจาเทอมจริงของฝ่ายจัดซื้อ</span><br>
      <b style="color:var(--orange);">⚠ ข้อจำกัดของข้อมูล:</b> โครงการเดือน มิ.ย. ฿{nf(credit['15d'][5])} ถูกบันทึกในระบบเป็น <b>เครดิต 15 วัน</b>
      แต่เงื่อนไขจริงเป็น <b>การแบ่งจ่ายหลายงวด และจ่ายผู้ขายเมื่อได้รับเงินจากลูกค้าแล้ว (Back-to-Back)</b> —
      ค่า {WA26:.1f} วันที่รวมโครงการนี้จึง<u>ต่ำกว่าความเป็นจริง</u> และไม่ควรนำไปสรุปว่ากระแสเงินสดแย่ลง (รายละเอียดในข้อ 8)<br>
      <span style="color:var(--text-dim);">ข้อเสนอ: เพิ่มประเภทเทอม "แบ่งงวด / Back-to-Back" ในระบบ แยกจากเครดิตวันปกติ เพื่อให้ตัวเลขนี้สะท้อนความจริง</span><br>
...
<tr><td style="text-align:left;">กระแสเงินสด <span class="badge gr">{WA26X:.1f} วัน</span></td>
  <td style="text-align:left;"><b>เครดิตเฉลี่ยถ่วงน้ำหนักของงานปกติ = {WA26X:.1f} วัน ดีกว่าปี 2025 ({WA25X:.1f} วัน) อยู่ {WA26X-WA25X:.1f} วัน</b> — คือผลงานการเจรจาเทอมจริง<br>
  โครงการ มิ.ย. ฿{credit['15d'][5]/1e6:.2f}M <b>ไม่กระทบกระแสเงินสด</b> เพราะเป็นงานแบ่งจ่ายหลายงวดแบบ Back-to-Back
  (จ่ายผู้ขายเมื่อได้รับเงินจากลูกค้าแล้ว) ปัจจุบันจ่ายเพียงเงินมัดจำ<br>
  <span style="color:var(--text-dim);">ค่ารวมทั้งหมด {WA26:.1f} วัน ต่ำกว่าความเป็นจริง เพราะระบบบันทึกโครงการนี้เป็นเครดิต 15 วัน</span></td></tr>
...
<tr><td style="text-align:left;">จุดต้องตัดสินใจ</td>
  ...
  2. <b>กระจุกตัวที่ Standard Parts {std_tot/T26*100:.1f}%</b> และผู้ขายรายเดียว 53.1% ของยอดซื้อ (ดูข้อ 9) — ต้องมีแผนรองรับความเสี่ยงด้าน Supply<br>
